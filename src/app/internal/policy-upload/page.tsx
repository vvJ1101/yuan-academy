...
export default function AdminPolicyPage() {
  ...
  return (<div className="p-6 md:p-8 lg:p-10 max-w-2xl">
    ...
    {checkingPermission ? (
      <div className="bg-white border border-neutral-200 rounded-xl p-6 text-[0.82rem] text-neutral-400">正在检查权限...</div>
    ) : !canUpload ? (
      <div className="bg-red-50 border border-red-100 rounded-xl p-6 text-[0.82rem] text-red-700">你没有上传订货政策的权限。</div>
    ) : (
